...
ARCH_URL="https://llaoj.oss-cn-beijing.aliyuncs.com/files/github.com/istio/istio/releases/download/${ISTIO_VERSION}/istio-${ISTIO_VERSION}-${OSEXT}-${ISTIO_ARCH}.tar.gz"
